...
def main(args, logger):
    ...
    # load data
    dataset = CellImageDataset46(datadir=args.datadir, metafile=args.metafile, mode='val')
    ...
    net = AE46(latent_variable_size=args.latent_dims)
